...
public:
    ...
    unsigned long (OnMousePointerShapeChange)(BOOL visible, BOOL alpha, ULONG xHot, ULONG yHot,
...
private:
    ...
    Framebuffer *maFramebuffers[MaxGuestMonitors];
