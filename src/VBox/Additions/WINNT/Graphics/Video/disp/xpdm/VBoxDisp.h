...
typedef struct _VM_EVENT_ARRAY
{                                  
    HANDLE hPaintEvent;        
...
} VM_EVENT_ARRAY, *PVM_EVENT_ARRAY;

typedef struct _COLORPOINTER
{
    bool fVisible;
    bool fAlpha;
    uint16_t u16HotX;
...
typedef struct _VBOXDISPDEV
{
    ...
    PEVENT pPaintEvent;
    HANDLE hRestartEvent;
    PEVENT pRestartEvent;
    HANDLE hExitEvent;
    PEVENT pExitEvent;

    HANDLE hPointerShapeEvent;
    PEVENT pPointerShapeEvent;
    HANDLE hPointerMoveEvent;
    PEVENT pPointerMoveEvent;
    RECT dirtyRect[MAX_DIRTY_RECT];
    ULONG rIndex;
    ULONG wIndex;
    SHORT pointerX;
    SHORT pointerY;
