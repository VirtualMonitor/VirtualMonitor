...
#ifdef VBOX
	__asm__ ( ".globl " STRINGIFY(GSYM(_real_mode_stack_size)) );
	__asm__ ( ".equ " STRINGIFY(GSYM(_real_mode_stack_size)) ", %c0" : : "i" (RM_STACK_SIZE) );
#else /* !VBOX */
...
uint16_t _real_call ( void *fragment, int fragment_len,
	...
	__asm__ ( "pushl %%ebp\n\t"
		  ...
		  "pushl %%eax\n\t"
#ifdef VBOX
		  "call  " STRINGIFY(GSYM(prepare_real_call)) "\n\t"	/* %eax = trampoline addr */
#else /* !VBOX */
		  "call  prepare_real_call\n\t"	/* %eax = trampoline addr */
#endif /* !VBOX */
		  "addl  $12, %%esp\n\t"
#ifdef VBOX
		  "call  " STRINGIFY(GSYM(_virt_to_phys)) "\n\t"	/* switch to phys addr */
#else /* !VBOX */
		  "call  _virt_to_phys\n\t"	/* switch to phys addr */
#endif /* !VBOX */
		  "call  *%%eax\n\t"		/* call to trampoline */
#ifdef VBOX
		  "call  " STRINGIFY(GSYM(_phys_to_virt)) "\n\t"	/* switch to virt addr */
#else /* !VBOX */
		  "call  _phys_to_virt\n\t"	/* switch to virt addr */
#endif /* !VBOX */
		  "movl  %%ebp, %%esp\n\t"	/* restore %esp & %ebp */
